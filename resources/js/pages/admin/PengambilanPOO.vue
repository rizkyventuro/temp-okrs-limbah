        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-6 items-center">
            <div class="w-full max-w-3xl flex flex-col gap-6">
                ...
                <div>
                        ...
                        <div class="flex h-8 w-8 items-center justify-center text-[#007C95]">
                            <svg width="24" height="24" viewBox="0 0 16 16" fill="none"
                                ...
                                <g clip-path="url(#clip0_25301_1724)">
                                    <path d="M10.6667 10.6667H14.6667" stroke="currentColor" stroke-width="1.33333"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M12.6667 8.66667V12.6667" stroke="currentColor" stroke-width="1.33333"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path
                                    ...
                                    <path d="M5 2.84666L11 6.28" stroke="currentColor" stroke-width="1.33333"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M2.19333 4.66667L8 8.00001L13.8067 4.66667" stroke="currentColor"
                                        stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M8 14.6667V8" stroke="currentColor" stroke-width="1.33333"
                                        stroke-linecap="round" stroke-linejoin="round" />
                                </g>
                                <defs>
                    ...
                    <div>
                        <p class="text-[14px] text-gray-500">Pilih titik asal minyak (POO) untuk mencatat pengambilan
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    <div class="relative flex-1">
                        ...
                        <input v-model="searchQuery" type="text" placeholder="Cari POO berdasarkan nama atau alamat..."
                            class="h-10.25 w-full rounded-core border border-gray-200 bg-white py-2.5 pl-10 pr-4 text-sm  placeholder-gray-400 focus:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-100" />
                    </div>
                    <Button @click="openCreate"
                        class="bg-primary hover:bg-primary-hover text-white px-5 py-2.5 font-medium text-sm shrink-0 rounded">
                        Tambah POO
                    </Button>
                </div>
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div v-for="poo in filteredPoos" :key="poo.id"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <button @click.stop="openDelete(poo)"
                    ...
                    <!-- Empty state -->
                    <div v-if="filteredPoos.length === 0"
                ...
                <DialogContent class="sm:max-w-md rounded-2xl p-0 overflow-hidden">
                    ...
                    <div class="grid gap-5 p-5">
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <textarea v-model="form.address" placeholder="Alamat lengkap" rows="3"
                                class="w-full rounded-core border border-gray-200 px-3 py-2.5 text-sm  placeholder-gray-400 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary-surface"
                                :class="{ 'border-red-400': form.errors.address }" />
                            <span v-if="form.errors.address" class="text-xs text-red-500">{{ form.errors.address
                                }}</span>
                        </div>
                        ...
                        <div class="grid gap-1.5">
                            ...
                            <Input v-model="form.contact" placeholder="0857373647" />
                        </div>
                        ...
                        <div class="grid gap-2">
                            ...
                            <div class="grid grid-cols-3 gap-2">
                                <button v-for="type in ['Restoran', 'UMKM', 'Rumah Tangga']" :key="type"
                                    @click="setType(type as any)"
                                    class="w-full rounded-core border py-2 text-sm font-medium transition" :class="selectedType === type
                    ...
                    <div class="grid grid-cols-2 gap-3 border-t border-gray-100 p-5">
                        <Button variant="outline" class="w-full text-gray-600 rounded" @click="isFormOpen = false">
                            Batal
                        </Button>

                        <Button @click="handleSubmit" :disabled="form.processing"
                            class="w-full bg-primary hover:bg-primary-hover text-white rounded">
                            {{ isEditing ? 'Simpan Perubahan' : 'Simpan & Pilih' }}
                        </Button>
                    </div>
                </DialogContent>
            </Dialog>
