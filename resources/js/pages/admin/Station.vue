...
const columns: ColumnDef<Station>[] = [
    ...
    },
    {
        ...
        header: ({ column }) => {
            ...
            }, () => ['Nama Stasiun', h(ArrowUpDown, { class: 'ml-2 h-4 w-4' })]);
        },
    },
    {
        accessorKey: 'code',
        header: ({ column }) => {
            return h(Button, {
                variant: 'ghost',
                onClick: () => column.toggleSorting(column.getIsSorted() === 'asc')
            }, () => ['Kode Stasiun', h(ArrowUpDown, { class: 'ml-2 h-4 w-4' })]);
        },
    },
    {
        accessorKey: 'city',
        ...
        <div>
                ...
                <DialogContent>
                    ...
                    <div class="grid gap-4 py-4">
                        <div class="grid gap-2">
                            <Label for="code">Kode Stasiun <span class="text-red-500">*</span></Label>
                            <Input
                                id="code"
                                v-model="form.code"
                        ...
                        <div class="grid gap-2">
                            <Label for="name">Nama Stasiun <span class="text-red-500">*</span></Label>
                            <Input
                                id="name"
                                v-model="form.name"
                        ...
                        <div class="grid gap-2">
                            <Label for="city">Kota <span class="text-red-500">*</span></Label>
                            <Input
                                id="city"
                                v-model="form.city"
                                placeholder="Contoh: Bandung"
                            ...
                            />
                            <span v-if="form.errors.city" class="text-sm text-red-500">{{ form.errors.city }}</span>
                        </div>
                        <div class="grid gap-2">
                            ...
                            />
                            <span v-if="form.errors.province" class="text-sm text-red-500">{{ form.errors.province }}</span>
                        </div>
                    </div>
                    <DialogFooter>
            ...
            <Dialog v-model:open="isEditOpen">
                <DialogContent>
                    ...
                    <div class="grid gap-4 py-4">
                        <div class="grid gap-2">
                            <Label for="edit-code">Kode Stasiun <span class="text-red-500">*</span></Label>
                            <Input 
                                id="edit-code" 
                                v-model="form.code"
                                :class="{ 'border-red-500': form.errors.code }"
                        ...
                        <div class="grid gap-2">
                            <Label for="edit-name">Nama Stasiun <span class="text-red-500">*</span></Label>
                            <Input 
                                id="edit-name" 
                                v-model="form.name"
                                :class="{ 'border-red-500': form.errors.name }"
                        ...
                        <div class="grid gap-2">
                            <Label for="edit-city">Kota <span class="text-red-500">*</span></Label>
                            <Input 
                                id="edit-city" 
                                v-model="form.city"
                                :class="{ 'border-red-500': form.errors.city }"
                        ...
                        <div class="grid gap-2">
                            <Label for="edit-province">Provinsi <span class="text-red-500">*</span></Label>
                            <Input 
                                id="edit-province" 
                                v-model="form.province"
                                :class="{ 'border-red-500': form.errors.province }"
